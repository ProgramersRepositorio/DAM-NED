...
public class Activity_2_botones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_2_botones);
        ...
        bot1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                switch(pantallaRef.getTipoActivity())
                {
                    case 1:
                    {
                        Intent intnt = new Intent(Activity_2_botones.this, Activity_1_boton.class);
                    ...
                    case 2:
                    {
                        Intent intnt = new Intent(Activity_2_botones.this, Activity_2_botones.class);
                        intnt.putExtra("codigoPantalla",pantallaActual.getOpcion1().getCodigoPantallaReferenciada());
                        startActivity(intnt);
                        finish();
                        break;
