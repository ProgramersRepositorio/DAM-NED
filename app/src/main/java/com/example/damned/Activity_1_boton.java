...
public class Activity_1_boton extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_1_boton);
        ...
        bot1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                switch (pantallaRef.getTipoActivity()) {
                    case 1: {
                        Intent intnt = new Intent(Activity_1_boton.this, Activity_1_boton.class);
                    ...
                    case 2: {
                        Intent intnt = new Intent(Activity_1_boton.this, Activity_2_botones.class);
                        intnt.putExtra("codigoPantalla", pantallaActual.getOpcion1().getCodigoPantallaReferenciada());
                        startActivity(intnt);
                        finish();
                        break;
                    ...
                    case 3: {
                        Intent intnt = new Intent(Activity_1_boton.this, Activity_3_botones.class);
                        intnt.putExtra("codigoPantalla", pantallaActual.getOpcion1().getCodigoPantallaReferenciada());
                        startActivity(intnt);
                        finish();
                        break;
